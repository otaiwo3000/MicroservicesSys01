    ...
    public class CustomAuthorizeFilterAttribute : Attribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
           ...
           ////IList<string> roles =  userManager.GetRolesAsync(user);
            ...
            var privsObj = new privs();

            var rolesprivilleges = privsObj.Rolesprivileges(context, userRoles_long);  //current user roles is used to get privilegeIDs
            ...
            var _requiredPrivilegeIDs = privsObj.PrivilegesByNames(context, RequiredPrivilegesArray);
